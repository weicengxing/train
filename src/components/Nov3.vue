...
import Nov4 from "./Nov4.vue";
import Vip from "./VIP.vue";
import VIP4 from "./VIP4.vue";
  ...
  mounted() {
    ...
    request.post("/deal/getnovelzong").then(res => {
      ...
      if (this.novelList && this.novelList.length > 0) {
        this.currentIndex = Math.max(0, Math.min(this.currentIndex, this.novelList.length - 1));
